...
3. The module-specific AGENTS.md for whichever subdirectory you're in:
   - `ExoCore/AGENTS.md` — Django backend
   - `ExoCore-Desktop/AGENTS.md` — React + Vite monorepo (3 SPAs)
   - `ExocoreExtension/AGENTS.md` — Windows desktop extensions
